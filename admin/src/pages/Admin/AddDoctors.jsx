...
const AddDoctors = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded max-w-3xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex-1 flex flex-col gap-1'>
              <p>Phone Number</p>
              <input onChange={(e) => setPhoneNumber(e.target.value)} value={phoneNumber} className='border rounded px-3 py-2' type='tel' placeholder='+91 9876543210' required />
            </div>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Experience</p>
        ...
        <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full font-semibold'>Add doctor</button>
